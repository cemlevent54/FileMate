...
class FileService {
    ...
    async createFile(fileData, file) {
        try {
            ...
            const uploadedFile = await this.fileRepository.createFile(fileDataToSave);
            return uploadedFile;
        } catch (error) {
    ...
    async getUserFiles(userId) {
        try {
            const files = await this.fileRepository.getUserFiles(userId);
            return files;
        } catch (error) {
